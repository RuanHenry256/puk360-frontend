...
export default function EventListing({ onBackToLogin, onSelectEvent }) {
  ...
  return (
    <div className="event-listing bg-surface text-text">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        ...
        {/* Search + Filters */}
        <section className="flex flex-col gap-4 rounded-2xl border border-secondary/40 bg-white/90 p-4 shadow-sm sm:p-6">
        ...
        <button
          ...
          className="w-full rounded-lg border border-secondary/50 bg-white px-4 py-2 text-sm font-semibold text-secondary transition-colors duration-150 hover:border-primary hover:text-primary sm:w-auto sm:self-center"
        >
          Back to Login
        </button>
      </div>
